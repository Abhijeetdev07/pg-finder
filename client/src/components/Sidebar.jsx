...
import { AiOutlineClose, AiOutlineHeart, AiOutlineCalendar, AiOutlineHome } from 'react-icons/ai';
    ...
    <>
      ...
      >
        ...
        <nav className="p-3 grid gap-2">
          <Link to="/" className="px-3 py-2 rounded hover:bg-gray-50 inline-flex items-center gap-2" onClick={onClose}>
            <AiOutlineHome className="text-gray-700" />
            <span>Home</span>
          </Link>
