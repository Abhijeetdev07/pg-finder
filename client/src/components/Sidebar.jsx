  ...
  return (
    <>
      ...
      <aside
        inert={!open}
        aria-hidden={!open}
        className={`fixed top-0 right-0 h-full w-[320px] max-[370px]:w-full bg-white z-50 border-l shadow-xl transform transition-transform duration-300 ${open ? 'translate-x-0' : 'translate-x-full'} flex flex-col`}
      >
