            ...
            <div className="space-y-6 w-full">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={`kpi-${i}`} className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                {Array.from({ length: 2 }).map((_, i) => (
                  <div key={`revenue-${i}`} className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                {/* Pie Chart Skeleton */}
                <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm lg:col-span-1">
                  <div className="h-5 w-32 bg-gray-200 rounded animate-pulse mb-4" />
                  <div className="h-[250px] bg-gray-100 rounded-lg animate-pulse mb-4" />
